 ...
 *                         - A following ACTION_START with BlockType=DEATHS will follow
 *
...
public class Game extends Entity implements Serializable {
    ...
    public boolean isGameRunning() {
        return !Step.BEGIN_MULLIGAN.eq(this.nextStep);
    }

    public boolean isMulliganOver() {
        return mulliganOver;
    }
    ...
    public void setStep(String step) {
        if (!mulliganOver && Step.MAIN_READY.eq(step)) {
            mulliganOver = true;
        }
        this.step = step;
    }
