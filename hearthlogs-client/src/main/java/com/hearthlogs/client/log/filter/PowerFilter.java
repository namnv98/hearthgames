 ...
 *
 *   ACTION_START Entity=[name=Ice Lance id=8 zone=HAND zonePos=1 cardId=CS2_031 player=1] SubType=POWER Index=-1 Target=[name=Azure Drake id=40 zone=PLAY zonePos=4 cardId=EX1_284 player=2]
